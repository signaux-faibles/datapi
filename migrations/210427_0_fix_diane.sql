alter table entreprise_diane add benefice_ou_perte real;
alter table entreprise_diane add ca_par_effectif real;
alter table entreprise_diane add taux_marge_commerciale real;
