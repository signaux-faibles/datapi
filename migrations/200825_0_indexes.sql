...
create index idx_etablissement_hash on etablissement (hash, version) where version in (0, 1);
...
create index idx_entreprise_hash on entreprise (hash, version) where version in (0, 1);
create index idx_entreprise_diane_hash on entreprise_bdf (hash, version) where version in (0, 1);
create index idx_entreprise_bdf_hash on entreprise_bdf (hash, version) where version in (0, 1);

create index idx_etablissement_procol_siret on etablissement_procol (siret) where version = 0;
create index idx_etablissement_procol_hash on etablissement_procol (hash, version) where version in (0, 1);

create index idx_etablissement_delai_siret on etablissement_delai (siret) where version = 0;
create index idx_etablissement_delai_hash on etablissement_delai (hash, version) where version in (0, 1);
...
create index idx_etablissement_periode_urssaf_hash on etablissement_periode_urssaf (hash, version) where version in (0, 1);
...
create index idx_etablissement_apconso_hash on etablissement_apconso (hash, version) where version in (0, 1);
...
create index idx_etablissement_apdemande_hash on etablissement_apdemande (hash, version) where version in (0, 1);
...
create index idx_score_hash on score (hash, version) where version in (0, 1);
